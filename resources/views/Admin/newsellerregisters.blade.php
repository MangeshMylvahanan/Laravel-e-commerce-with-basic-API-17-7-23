                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td> {{ $user->email }} </td>
                                        <td> {{ $user->mobile }} </td>
                                        <td> {{ $user->seller_address }} </td>
                                        <td><button onclick="addfunc({{ $user->id }})" class="badge badge-outline-success">Accept</button></td>
                                        <td><button onclick="removefunc({{ $user->id }})" class="badge badge-outline-danger">Decline</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
