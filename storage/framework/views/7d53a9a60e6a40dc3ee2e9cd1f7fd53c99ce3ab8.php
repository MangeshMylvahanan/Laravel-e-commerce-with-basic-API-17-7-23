            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                <div class="col-lg-6 text-lg-right pr-lg-4">
                  <h5 class="display-1 mb-0">Thankyou</h5>
                </div>
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  <h4>We will check your register details.</h4>
                  <h3 class="font-weight-light">Then Contact you by a mail..</h3>
                </div>
              </div>
              <div class="row mt-5">
...
</html><?php /**PATH C:\Users\Mangesh Mylvahanan\Laravel\Template\resources\views/Auth/waitlist.blade.php ENDPATH**/ ?>